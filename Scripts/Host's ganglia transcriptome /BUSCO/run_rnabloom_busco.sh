...
# INPUT: #
Contigs=/home/LVP/assembly/QC/rnabloom_TransRate_output/ganglia.new_ref_rnabloom.cdhit_c95/good.ganglia.new_ref_rnabloom.cdhit_c95.fasta
TAG=good_Pret_new_ref_rnabloom_vs_Metazoa_odb10
