...
gene_ont <- read.csv2("/home/lisa/Downloads/Telegram Desktop/raki_outputs/emapper_annotations.tsv", skip = 4,
                           header = T, sep="\t")
...
write.table(gene_ontuni, file = sprintf("/home/lisa/Downloads/Telegram Desktop/raki_outputs/%s_GeneOntologyUniverse_filtered.txt", 
                                      species_tag), sep="\t",
            col.names = FALSE, row.names = FALSE)

### Input data ###
species_geneID2GO <- readMappings(file="/home/lisa/Downloads/Telegram Desktop/raki_outputs/Pmin_go.txt")
species_geneNames <- names(species_geneID2GO)

molsign_tab <- read.csv2("/home/lisa/Downloads/Telegram Desktop/raki_outputs/Pmin_RNentropy_significant_results.tsv", 
                         header = T, sep="\t")
...
for (stage in stages){
  ...
  output_file_name <- sprintf("/home/lisa/Downloads/Telegram Desktop/raki_outputs/%s_%s_overexpr_genes_GOenrichment_BP_Fisher.min_10_genes.tsv", 
                              species_tag, stage)
  ...
  # Visualization #
  # Plot #
  pdf(file=sprintf("/home/lisa/Downloads/Telegram Desktop/raki_outputs/%s_%s_overexpr_genes_reduced_GSEA_results.Dmelanogaster_parent_GOterms.pdf", species_tag, stage), width = 10, height = 12)
  ...
  dev.off()
  # ScatterPlot #
  pdf(file=sprintf("/home/lisa/Downloads/Telegram Desktop/raki_outputs/%s_%s_overexpr_genes_reduced_GSEA_results.Dmelanogaster.scatterPlot.pdf", 
  ...
  write.table(stage_reducedTerms, 
              file=sprintf("/home/lisa/Downloads/Telegram Desktop/raki_outputs/%s_%s_overexpr_genes_reduced_GSEA_results.Dmelanogaster.tsv", 
                           species_tag, stage),
