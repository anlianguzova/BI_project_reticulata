...
Contigs=/home/LVP/assembly/CDHIT_cluster_95_percent/ganglia.new_ref_rnabloom.cdhit_c95.fasta # Full path to the fasta file with assembled contigs (length >= 200 bp)
OUTDIR=/home/LVP/assembly/QC/rnabloom_TransRate_output # Full path to the directory where the quality control results will be stored
